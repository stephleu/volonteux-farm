...
import { LayoutDashboard, Map, Tractor, Sprout, Calendar, History, Settings, Shield, Layers } from 'lucide-react'

const nav = [
  { to: '/', icon: LayoutDashboard, label: 'Tableau de bord' },
  { to: '/plan/assolement', icon: Map, label: 'Assolement', parent: 'plan' },
  { to: '/plan/series', icon: Layers, label: 'Séries', parent: 'plan' },
